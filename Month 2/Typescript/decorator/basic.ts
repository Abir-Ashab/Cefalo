...
{
    function SimpleLogger2(constructor: any, name: string) { // receiving the constructor as any which is the class itself, the functions, properties, etc. so it is valid
